...
import revisaodm2021n.telas.restaurante.ManterRestaurante;
...
public class RevisaoDM2021N {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        JOptionPane.showMessageDialog(null,"SISTEMA DE CADASTRO RESTAURANTE, DEPARTAMENTO E USUARIO");
        JOptionPane.showMessageDialog(null,"ENTRE COM: 1 - PESSOAS, 2 - DEPARTAMENTO, 3 - USUARIO, 4 - RESTAURANTE");
        ...
        if(sistema == 3 ) {
         ...
         if(sistema == 4 ) {
            ...
            JOptionPane.showMessageDialog(null,"SISTEMA DE CADASTRO RESTAURANTE");
            JOptionPane.showMessageDialog(null,"ENTRE COM: 1 - INSERIR, 2 - ALTERAR, 3 - BUSCAR, 4 - LISTA, 5 - EXCLUIR");

            int opcao = Integer.parseInt(JOptionPane.showInputDialog("ENTRE COM A OPÇÃO"));
        
            if(opcao == 1) { ManterRestaurante.Inserir(); }

            if(opcao == 2) { ManterRestaurante.Alterar(); }

            if(opcao == 3) { ManterRestaurante.Buscar(); }

            if(opcao == 4) { ManterRestaurante.Listar(); }

            if(opcao == 5) { ManterRestaurante.Excluir(); }
