...
<html>
    ...
    <div class="container"/>
        ...
        <% if(uSaida != null) { %>
            ...
            Restaurante = <a href="../Restaurante/buscaRestaurante.jsp">Buscar</a> = <a href="../Restaurante/listaRestaurante.jsp">Lista</a> = <a href="../Restaurante/inseriRestaurante.jsp">Inserir</a>
        <% } else { %>
